...
export default function Home() {
  return (
    ...
    <Category catname="피처링">
      <PersonCard link="/app/rujin" label labeltext="영상통화" price="6만 ₩" opt={["Photos","Albums"]} name="Rujin" category="Itzy" picture="https://dbkpop.com/wp-content/uploads/2019/07/itzy_itz_icy_concept_profile_ryujin.jpg"/>
      <PersonCard link="/app/jennie" label labeltext="포스터" price="6만 ₩" opt={["포스터s","Albums"]} name="Jennie" category="BLACKPINK" picture="https://i.pinimg.com/736x/f2/bc/6d/f2bc6d65fa4a708563e4db75c27fbb7c.jpg"/>
      <PersonCard link="/app/momo" label labeltext="포스터" price="6만 ₩" opt={["포스터s","Albums"]} name="Momo" category="Twice" picture="https://i.pinimg.com/originals/c3/79/e4/c379e4ad3337a490ea21445056d81ab4.jpg"/>
