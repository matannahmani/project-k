...
export default function Home() {
  return (
    ...
    <Category catname="피처링">
      <PersonCard link="/app/person" label labeltext="영상통화" price="5$" opt={["Photos","Albums"]} name="Rujin" category="Itzy" picture="https://dbkpop.com/wp-content/uploads/2019/07/itzy_itz_icy_concept_profile_ryujin.jpg"/>
